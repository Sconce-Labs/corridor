...
const _descriptor_2 = new __compactRuntime.CompactTypeUnsignedInteger(999n, 2);
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      enterCorridor: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`enterCorridor: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const entitlement_0 = args_1[1];
        const entryTag_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('enterCorridor',
                                     'argument 1 (as invoked from Typescript)',
                                     'counter.compact line 35 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(typeof(entitlement_0) === 'bigint' && entitlement_0 >= 0n && entitlement_0 <= 999n)) {
          __compactRuntime.typeError('enterCorridor',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(entitlement_0).concat(_descriptor_0.toValue(entryTag_0)),
        ...
        const result_0 = this._enterCorridor_0(context,
                                               partialProofData,
                                               entitlement_0,
                                               entryTag_0);
    ...
    this.impureCircuits = { enterCorridor: this.circuits.enterCorridor };
    this.provableCircuits = { enterCorridor: this.circuits.enterCorridor };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('enterCorridor', new __compactRuntime.ContractOperation());
  ...
  _enterCorridor_0(context, partialProofData, entitlement_0, entryTag_0) {
    __compactRuntime.assert(entitlement_0 > 0n, 'no corridor entitlement');
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(1n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(entryTag_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    return [];
  }
